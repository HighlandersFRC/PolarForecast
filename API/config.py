...
# Specifies if the Polar Forecast API should skip matches that fail data integrity checks.
MATCH_SANITIZATION = os.environ.get('PF_MATCH_SANITIZATION', True)
...
# Species if the Polar Forecast API should Poll Orange Alliance for Data
TOA_POLLING = os.environ.get("PF_TOA_POLLING", False)
TOA_POLLING_INTERVAL = os.environ.get(
    "PF_TOA_POLLING_INTERVAL", 10 * 60)  # Polling interval in seconds
...
# Mongo Parameters
MONGO_CONNECTION = os.environ.get(
