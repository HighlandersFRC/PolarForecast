...
class ScouterDocumentation extends StatelessWidget {
  const ScouterDocumentation({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: buildSection(
                      ...
                      content:
                          'Return to the pit scouting form for a given team. The page will display the fields recorded in the previous entry, which can be overwritten on submission to change previously scouted information.',
                  ...
                  Container(
                    ...
                    child: buildSection(
                      ...
                      content:
                          'We chose to include each team’s rank, simulated rps, auto score, auto coral points, teleop coral points, net, processor, climb rate, OPR, and death rate. This data is organized into a table sortable by any field.',
                  ...
                  Container(
                    ...
                    child: buildSection(
                      ...
                      content:
                          'The team comparison tool allows you to compare two teams side-by-side across various metrics, including scoring, defense, and reliability.',
