                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      if (widget
                                                                        ...
                                                                        ElevatedButton(
                                                                            ...
                                                                            child:
                                                                                Text('Create an Alliance', style: TextStyle(fontFamily: 'Font'))),
                                                                      SizedBox(
                                                                          height:
                                                                              10),
                                                                      if (widget
                                                                      ...
                                                                      if (widget
                                                                          ...
                                                                          0)
                                                                        ExpansionPanelList.radio(
                                                                            children: List.generate(widget.group!.events[event_index].alliance_groups.length, (int alliance_index) {
                                                                          return ExpansionPanelRadio(
                                                                              canTapOnHeader: true,
                                                                              value: alliance_index,
                                                                              headerBuilder: (context, expanded) => ListTile(title: Text('${widget.group!.events[event_index].alliance_groups[alliance_index].name} - ${widget.group!.events[event_index].alliance_groups[alliance_index].affiliation.substring(3)}', style: TextStyle(fontFamily: 'Font'), overflow: TextOverflow.ellipsis)),
                                                                              body: Row(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    if (event_requests
                                                                      ...
                                                                      ExpansionPanelList
                                                                          .radio(
                                                                              children: List.generate(event_requests.length, (request_index) {
                                                                        final request =
                                                                            event_requests[request_index];
                                                                        if (request.group_1 ==
                                                                            widget.group!.name)
                                                                          return ExpansionPanelRadio(
                                                                              canTapOnHeader: true,
