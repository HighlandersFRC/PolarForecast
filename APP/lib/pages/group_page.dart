                                                                  ...
                                                                  children: [
                                                                    if (widget
                                                                      ...
                                                                      ElevatedButton(
                                                                          ...
                                                                          onPressed:
                                                                              () {
                                                                            apiService.leave_alliance(widget.group!.name, widget.group!.events[event_index].event_code, widget.group!.events[event_index].alliance_groups[alliance_index].name).then(
                                                                                (val) {
                                                                              var (
                                                                                group,
                                                                                membership
