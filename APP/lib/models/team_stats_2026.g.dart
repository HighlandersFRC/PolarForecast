...
_$TeamStats2026Impl _$$TeamStats2026ImplFromJson(Map<String, dynamic> json) =>
    _$TeamStats2026Impl(
      ...
      auto_fuel_cycles: (json['auto_fuel_cycles'] as num?)?.toDouble() ?? 0.0,
      teleop_fuel_cycles:
          (json['teleop_fuel_cycles'] as num?)?.toDouble() ?? 0.0,
      total_fuel_cycles: (json['total_fuel_cycles'] as num?)?.toDouble() ?? 0.0,
...
Map<String, dynamic> _$$TeamStats2026ImplToJson(_$TeamStats2026Impl instance) =>
    <String, dynamic>{
      ...
      'total_fuel_cycles': instance.total_fuel_cycles,
